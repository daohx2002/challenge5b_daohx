...
<table class="table table-bordered">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $each): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($each->fullname != session('fullname')): ?>
        <tr>
            ...
            <?php endif; ?>
            <td>
               <form action="<?php echo e(route('user' , $each)); ?> ">
...
<?php /**PATH C:\laragon\www\challenge5b_daohx\resources\views/teacher/index.blade.php ENDPATH**/ ?>